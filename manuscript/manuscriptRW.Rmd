...
recruitment diameters thresholds of 7 and 10 cm varied across model
...
(visible from the IQR
in the box plots of Figure \@ref(fig:over)) is similar to or smaller
than the observed
variability for most of the models, with the exception of PICUS, where
the mean
recruitment variability is much larger.
...
```{r nvTrend710BA, echo=FALSE, fig.cap="Mean recruitment values across samples for the 200 sites. The values have been divided in 10 bins and the red lines represent a GAM model showing the trend from the observed data.", fig.show = 'hold', out.width = '50%'}
