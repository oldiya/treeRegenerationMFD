...
```{r plotComp, echo=FALSE, warning=FALSE, fig.cap="Plot and summary atatiatics of the linear model between the overestimation proportion in ingrowth levels and the mean complexity value of the establisment modules", fig.show = 'hold', out.width = '70%'}
