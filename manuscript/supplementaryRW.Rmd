...
```{r envTrend7dds, echo=FALSE, fig.cap="Mean recruitment values across samples for the 200 sites against the site seasonal degree-day sum. (A)same y-axis across all models; (B) y-axis scaled by model. The values were split into 10 bins; the red lines represent a GAM model showing the trend in the observed data.", fig.show = 'hold', out.width = '80%'}
...
differences of the approaches used.
